...
export default async function BookingReviewPage({ params, searchParams }: { params: Promise<{ serviceId: string }>; searchParams: Promise<{ date?: string; time?: string }> }) {
  ...
  return <BookingReview service={service} date={query.date} time={query.time} />;
}
