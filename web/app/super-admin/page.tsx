...
export default async function SuperAdminPage() {
  ...
  const [applications, providerApplications, providerVerifications, serviceLaunches, locations, categories, admins, auditEvents] = await Promise.all([
  ...
  return <main className="container section-stack">
    <section className="page-intro"><span className="eyebrow">SaaS control plane</span><h1>Super Admin</h1><p>Manage the takeitesee ecosystem across provider access, verification, controlled service launch, applications, markets, categories, and delegated administrators.</p></section>
    ...
    <section className="card"><h2>Control plane</h2><p>Provider onboarding, trust verification, and service launch scope are separate guarded decisions. Public service activation requires all three launch gates.</p>
