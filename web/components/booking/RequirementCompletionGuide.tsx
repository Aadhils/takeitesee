    ...
    : hasSupport
      ...
      : !confirmed && closeout.can_confirm_completion
        ...
        : confirmed && !hasReview
          ? {
              tone: 'success' as const,
              label: t('requirementCompletion.customer.acknowledged.label'),
              title: t('requirementCompletion.customer.acknowledged.title'),
              body: t('requirementCompletion.customer.acknowledged.body'),
            }
          : {
              tone: 'success' as const,
