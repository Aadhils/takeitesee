...
const english = {
  ...
  'requirementCompletion.customer.review.label': 'Acknowledged',
  'requirementCompletion.customer.review.title': 'Completion confirmed — review is the next step',
  'requirementCompletion.customer.review.body': 'Your completion acknowledgement is recorded. Use the review section further down this booking page to rate the experience; support remains available while its window is open.',
...
const tamil: Record<RequirementCompletionKey, string> = {
  'requirementCompletion.eyebrow': 'Service completion',
  'requirementCompletion.confirmFallback': 'Completion-ஐ confirm செய்ய முடியவில்லை.',
  ...
  'requirementCompletion.customer.review.label': 'Acknowledged',
  'requirementCompletion.customer.review.title': 'Completion confirmed — Review அடுத்த step',
  'requirementCompletion.customer.review.body': 'Service completion acknowledgement பதிவு செய்யப்பட்டுள்ளது. இந்த booking page-ல் கீழே உள்ள review section மூலம் உங்கள் experience-ஐ பதிவு செய்யலாம்; issue இருந்தால் support window இருக்கும் வரை help பெறலாம்.',
  'requirementCompletion.customer.reviewed.label': 'Reviewed',
