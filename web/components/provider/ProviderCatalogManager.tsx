...
export function ProviderCatalogManager() {
  ...
  return <LiveProviderShell active="/provider/services">
    ...
    {!loading && !selectableCategories.length ? <Alert title="Platform categories required" tone="warning">No selectable Admin-managed categories are active yet. A Super Admin must add or activate specific leaf categories before Providers can create new services.</Alert> : null}
