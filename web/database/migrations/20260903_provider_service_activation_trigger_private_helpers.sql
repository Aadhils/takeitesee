-- Launch readiness: repair provider service activation after Phase 17 moved
-- marketplace readiness helpers to the private schema.
--
-- The trigger body is PL/pgSQL and resolves helper names at execution time, so
-- references to removed public helper names break provider activation even though
-- the services RLS policies retained their stored dependencies correctly.
--
-- Keep all readiness primitives private and preserve the existing activation gates.
