-- Universal Services: expose selected weekdays in provider booking requirement context.
-- Read-only context extension; booking lifecycle and finance behavior are unchanged.
