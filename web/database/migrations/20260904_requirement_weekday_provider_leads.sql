-- Universal Services Ecosystem: expose selected weekdays in provider requirement lead read model.
-- Keeps matching, proposal, lifecycle and finance behavior unchanged.
    ...
    'leads',coalesce((
      ...
      from (
        select jsonb_build_object(
          ...
          'recurrence_weekdays',r.recurrence_weekdays,
