...
const [appShellSource, globalSwitcherSource, globalSwitcherCss, accountSwitcherSource, routeSource, globalsCss] = await Promise.all([
...
test('global switcher escapes sticky filtered header through a body portal', () => {
...
test('global switcher stays responsive as desktop popover and mobile bottom sheet', () => {
